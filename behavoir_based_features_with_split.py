...
X_train2, X_test2, train_y2, valid_y2 = [],[],[],[]
##
##cur3.execute("select  "
##+"Min_Val_Sent ,"
###+"Avg_Val_Sent  ,"
...
##+"Gini_amt_out   ,"
##+"Gini_amt_in   ,"
##+"label  from test_behaviour2 order by id")
###rows1 = cur1.fetchall()
###rows2 = cur2.fetchall()
##rows3 = cur3.fetchall()
...
+"Gini_amt_out   ,"
+"Gini_amt_in   ,"
+"label  from tarining_behaviour2")
rows3 = cur3.fetchall()
...
print ("ExtraTreesClassifier, behavior based features  : ", accuracy5)
...
est_Ensemble = VotingClassifier(estimators=[('RF', est_BA), ('xgb', est_XGB)],
                        voting='soft',
                        weights=[1,1])
####
